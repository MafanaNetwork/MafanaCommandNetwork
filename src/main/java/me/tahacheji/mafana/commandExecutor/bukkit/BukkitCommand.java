...
import me.tahacheji.mafana.commandExecutor.help.HelpNode;
import me.tahacheji.mafana.commandExecutor.node.ArgumentNode;
import me.tahacheji.mafana.commandExecutor.node.CommandNode;
import me.tahacheji.mafana.commandExecutor.paramter.ParamProcessor;
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if(node.getMatchProbability(sender, label, args, false) < 90) {
            ...
            if(!helpNode.getPermission().isEmpty() && !sender.hasPermission(helpNode.getPermission())) {
                sender.sendMessage(ChatColor.RED + "I am sorry, although you do not have permission to execute this command.");
                return false;
            }
